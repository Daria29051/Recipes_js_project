...
<a class="login__forgot-password" href="#!">Forgot password?</a>
 ...
 <a class="login__register-link" href="#!">Register here</a>
  ...
  const confirmPassword = document.querySelector(
    ".login__confirm-password-part"
  ); //блок Confirm Password
  ...
  function checkValidity() {
    ...
    const confirmPasswordInput = document.querySelector(
      ".login__confirm-password"
    ); //input ввода confirm-password
    ...
    if (
      firstName.classList.contains("hidden") === false &&
    ...
    if (
      lastName.classList.contains("hidden") === false &&
      lastNameInput.value === ""
    ) {
    ...
    if (
      confirmPassword.classList.contains("hidden") === false &&
